...
namespace HubbleGalaxyHotelApp.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AccountNumber,NameOfAccount,UserId")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AccountNumber,NameOfAccount,UserId")] PaymentType paymentType)
        {
