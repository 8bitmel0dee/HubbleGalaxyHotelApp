...
namespace HubbleGalaxyHotelApp.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RoomName,PricePerNight,RoomDescription,RoomFeatures,RoomImage,UserId")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoomName,PricePerNight,RoomDescription,RoomFeatures,RoomImage,UserId")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
